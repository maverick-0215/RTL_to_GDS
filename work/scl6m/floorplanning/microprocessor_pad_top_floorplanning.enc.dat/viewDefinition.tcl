...
create_constraint_mode -name functional\
   -sdc_files\
    [list ${::IMEX::libVar}/mmmc/microprocessor_pad_top_incremental.sdc]
create_analysis_view -name best_case -constraint_mode functional -delay_corner min_delay
create_analysis_view -name worst_case -constraint_mode functional -delay_corner max_delay
